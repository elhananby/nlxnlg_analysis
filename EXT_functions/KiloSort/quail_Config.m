...
ops.datatype            = 'nlg';  % binary ('dat', 'bin') or 'openEphys'		
ops.fbinary             = 'D:\new_exp_data\nlg_animal20_Day30618_1\test.dat'; % will be created for 'openEphys'		
ops.fproc               = 'D:\new_exp_data\nlg_animal20_Day30618_1\temp_wh.dat'; % residual from RAM of preprocessed data		
ops.root                = '\\GutfreundNLX\CheetahData\20_W18_nlg2018-06-03_13-51-14\nlg_data'; % 'openEphys' only: where raw files are		
		
ops.fs                  = 32150;        % sampling rate		(omit if already in chanMap file)
...
ops.chanMap             = 'D:\new_exp_data\nlg_animal20_Day30618_1\chanMap.mat'; % make this file using createChannelMapFile.m		
...
ops.nannealpasses    = 8;            % should be less than nfullpasses (4)		
